...
class StorePunjabActionPlanRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'indicator_framework_file'=>'required|mimes:jpg,jpeg,png,pdf',
            'baseline'=>'required',
    ...
    public function messages()
    {
        return [
            ...
            'indicator_framework_file.required'=> 'Indicator framework file is required.',
