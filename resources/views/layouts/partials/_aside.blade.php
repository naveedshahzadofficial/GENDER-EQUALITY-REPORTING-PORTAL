						...
						<div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
							...
							<ul class="menu-nav">
                                ...
                                @if(auth()->user()->isAdmin())
                                    ...
                                    <li class="menu-item {{ areActiveRoutes(['targets.index','targets.create','targets.edit']) }}" aria-haspopup="true">
                                    <a href="{{ route('targets.index') }}" class="menu-link">
										<span class="svg-icon menu-icon">
											<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
												<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
													<polygon points="0 0 24 0 24 24 0 24" />
                                    ...
                                    <li class="menu-item {{ areActiveRoutes(['indicators.index','indicators.create','indicators.edit']) }}" aria-haspopup="true">
                                    ...
                                    <li class="menu-item {{ areActiveRoutes(['project-types.index','project-types.create','project-types.edit']) }}" aria-haspopup="true">
                            ...
                            @if(auth()->user()->isTable2() || auth()->user()->isPAPDepartment() || auth()->user()->isAdmin())
                            ...
                            @if((auth()->user()->isTable1() && auth()->user()->isPoliceDepartment()) || auth()->user()->isAdmin() || auth()->user()->isPAPDepartment())
                                ...
                                @if((auth()->user()->isTable1() && auth()->user()->isFiaDepartment()) || auth()->user()->isAdmin() || auth()->user()->isPAPDepartment())
                                ...
                                @if((auth()->user()->isTable1() && auth()->user()->isOmbudspersonDepartment()) || auth()->user()->isAdmin() || auth()->user()->isPAPDepartment())
                                <li class="menu-item {{ areActiveRoutes(['women-ombudsperson-violences.index','women-ombudsperson-violences.create','women-ombudsperson-violences.edit','women-ombudsperson-violences.show']) }}" aria-haspopup="true">
                                    <a href="{{ route('women-ombudsperson-violences.index') }}" class="menu-link">
                                        ...
                                        <span class="menu-text">{{ auth()->user()->isAdmin() || auth()->user()->isPAPDepartment()?'Women Ombudsperson: Violence Against Women':'Violence Against Women' }}</span>
                                    </a>
                                </li>
                                @endif
