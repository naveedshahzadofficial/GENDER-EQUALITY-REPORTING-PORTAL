...
@push('title', 'Add Violence Against Children and Women')
                ...
                <div class="">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header">
                            <h3 class="card-title">Add Violence Against Children and Women</h3>

                        </div>

                        <!--begin::Form-->
                        {!! Form::open(array('id'=>'form_add_edit','route' => 'police-department-violences.store','method'=>'POST','files' => 'true')) !!}
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input  type="text" name="child_abuse" class="form-control crime_stats money_format" placeholder="Child Abuse" value="{{ old('child_abuse') }}" />
                                    @error('child_abuse')
                                    <div class="error">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input  type="text" name="child_abuse_murder" class="form-control crime_stats money_format" placeholder="Child Abuse and Murder" value="{{ old('child_abuse_murder') }}" />
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input  type="text" name="child_labour" class="form-control crime_stats money_format" placeholder="Child Labour" value="{{ old('child_labour') }}" />
                                    @error('child_labour')
                                    <div class="error">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input  type="text" name="child_marriage" class="form-control crime_stats money_format" placeholder="Child Marriage" value="{{ old('child_marriage') }}" />
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input  type="text" name="women_murder" class="form-control crime_stats money_format" placeholder="Murder" value="{{ old('women_murder') }}" />
                                    @error('women_murder')
                                    <div class="error">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input  type="text" name="women_domestic_violence" class="form-control crime_stats money_format" placeholder="Domestic Violence" value="{{ old('women_domestic_violence') }}" />
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input  type="text" name="women_rape" class="form-control crime_stats money_format" placeholder="Rape" value="{{ old('women_rape') }}" />
                                    @error('women_rape')
                                    <div class="error">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="col-lg-6">
                                    ...
                                    <input  type="text" name="women_gang_rape" class="form-control crime_stats money_format" placeholder="Gange Rape" value="{{ old('women_gang_rape') }}" />
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input  type="text" name="women_kidnapping" class="form-control crime_stats money_format" placeholder="Kidnapping/ Abduction" value="{{ old('women_kidnapping') }}" />
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input  type="text" name="women_burning" class="form-control crime_stats money_format" placeholder="Burning" value="{{ old('women_burning') }}" />
                                    @error('women_burning')
                                    <div class="error">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input  type="text" name="women_honour_killing" class="form-control crime_stats money_format" placeholder="Honour Killing of Women" value="{{ old('women_honour_killing') }}" />
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input  type="text" name="women_vani" class="form-control crime_stats money_format" placeholder="Vani" value="{{ old('women_vani') }}" />
                                    @error('women_vani')
                                    <div class="error">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input  type="text" name="women_forced_bonded_labour" class="form-control crime_stats money_format" placeholder="Forced/ Bonded Labour" value="{{ old('women_forced_bonded_labour') }}" />
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input  type="text" name="women_other" class="form-control crime_stats money_format" placeholder="Other Violence against Women" value="{{ old('women_other') }}" />
                                    @error('women_other')
                                    <div class="error">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="row form-group">
                                <div class="col-lg-6">
                                    ...
                                    <input readonly type="text" id="total_stats" name="total" class="form-control money_format" placeholder="Total" value="{{ old('total') }}" />
                                    @error('total')
                                    <div class="error">{{ $message }}</div>
                                    @enderror
                                </div>
