            ...
            <div class="">
                <div class="">
                    ...
                    <div class="card card-custom gutter-b">
                        ...
                        <!--begin::Form-->
                        {!! Form::open(array('id'=>'form_add_edit','route' => ['women-ombudsperson-violences.update', $womenOmbudspersonViolence],'method'=>'PUT','files' => 'true')) !!}
                        <div class="card-body">
                                ...
                                <div class="col-lg-6 @if(!empty(auth()->user()->department_id)) d-none @endif">
                                    ...
                                    <select class="form-control select2" name="department_id">
                                        ...
                                        @foreach($departments as $department)
                                            <option {{ old('department_id',$womenOmbudspersonViolence->department_id)== $department->id ? 'selected': '' }} value="{{ $department->id }}"> {{ $department->department_name }} </option>
                                        @endforeach
                                    </select>
                                    @error('department_id')
                                    ...
                                    <select class="form-control select2" name="district_id">
                                        ...
                                        @if(isset($districts) && !empty($districts))
                                            @foreach($districts as $district)
                                                <option {{ old('district_id', $womenOmbudspersonViolence->district_id)== $district->id ? 'selected': '' }} value="{{ $district->id }}"> {{ $district->district_name_e }} </option>
                                            @endforeach
                                        @endif
                                    </select>
                                    @error('district_id')
                                    ...
                                    <select class="form-control select2" name="month_id">
                                        ...
                                        @if(isset($months) && !empty($months))
                                            @foreach($months as $month)
                                                <option {{ old('month_id', $womenOmbudspersonViolence->month_id)== $month->id ? 'selected': '' }} value="{{ $month->id }}"> {{ $month->month_name }} </option>
                                            @endforeach
                                        @endif
                                    </select>
                                    @error('month_id')
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <select class="form-control select2" name="year">
                                        ...
                                        @for($i=date('Y'); $i>=2015; $i--)
                                            <option {{ old('year', $womenOmbudspersonViolence->year)== $i ? 'selected': '' }} value="{{ $i }}"> {{ $i }} </option>
                                        @endfor
                                    </select>
                                    @error('year')
                                    <div class="error">{{ $message }}</div>
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input  type="text" name="complaints_proceeding_initiated" class="form-control money_format" placeholder="Complaints Proceeding Initiated" value="{{ old('complaints_proceeding_initiated', $womenOmbudspersonViolence->complaints_proceeding_initiated) }}" />
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input  type="text" name="complaints_disposed_without_proceeding_initiated" class="form-control money_format" placeholder="Complaints Disposed without Initiating Proceeding" value="{{ old('complaints_disposed_without_proceeding_initiated',$womenOmbudspersonViolence->complaints_disposed_without_proceeding_initiated) }}" />
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input  type="text" name="total_cases_completed" class="form-control money_format" placeholder="Total Case Completed" value="{{ old('total_cases_completed',$womenOmbudspersonViolence->total_cases_completed) }}" />
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input  type="text" name="total_cases_in_progress" class="form-control money_format" placeholder="Total Cases in Progress" value="{{ old('total_cases_in_progress',$womenOmbudspersonViolence->total_cases_in_progress) }}" />
