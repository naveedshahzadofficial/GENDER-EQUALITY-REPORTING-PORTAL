...
class UpdatePoliceDepartmentViolenceRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'month_id'=>['required', Rule::unique('police_department_violences', 'month_id')->where('department_id', $this->department_id)->where('district_id', $this->district_id)->where('year', $this->year)->ignore($this->police_department_violence)],
            'year'=>'required',
