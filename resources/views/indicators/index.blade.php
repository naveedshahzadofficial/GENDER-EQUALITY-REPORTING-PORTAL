...
@push('title', 'Indicators')
@push('breadcrumb-items')
    <li class="breadcrumb-item">
        <a class="text-muted">Indicators</a>
    </li>
@endpush
@section('content')
    <!--begin::Entry-->
            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap border-0 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Indicators</h3>
                    </div>
                        <div class="card-toolbar">
                        <!--begin::Button-->
                        <a href="{{ route('indicators.create') }}" class="btn btn-primary bg-white btn-outline-white text-danger font-weight-bolder">New Indicator</a>
                        <!--end::Button-->
                    </div>
                </div>
                <div class="card-body">
