                ...
                <div class="">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header">
                            <h3 class="card-title">Add Project Type</h3>

                        </div>

                        <!--begin::Form-->
                        {!! Form::open(array('id'=>'form_add_edit','route' => 'project-types.store','method'=>'POST','files' => 'true')) !!}
                        <div class="card-body">
                            <div class="row form-group">
                                <div class="col-lg-6">
                                    <label>Title <span class="color-red-700">*</span></label>
                                    <input type="text" name="project_type_title" class="form-control" placeholder="Title" value="{{ old('project_type_title') }}" />
                ...
                document.getElementById('form_add_edit'),
                {
                    fields: {
                        project_type_title: {
                            validators: {
                                notEmpty: {
                                    message: 'Project Type title is required'
                                }
                            }
                        },
                    },
