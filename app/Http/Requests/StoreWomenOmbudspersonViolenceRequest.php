...
class StoreWomenOmbudspersonViolenceRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'month_id'=>['required', Rule::unique('women_ombudsperson_violences', 'month_id')->where('department_id', $this->department_id)->where('district_id', $this->district_id)->where('year', $this->year)],
            'year'=>'required',
