                        ...
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" name="total_approved_budget" style="width: 100% !important;" class="form-control money_format" placeholder="Approved Budget" value="{{ old('total_approved_budget') }}" />
