...
@push('title', 'Punjab Action Plans')
@push('breadcrumb-items')
    <li class="breadcrumb-item">
        <a class="text-muted">Punjab Action Plans</a>
    </li>
@endpush
@section('content')
    <!--begin::Entry-->
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            myDataTable = $('#my_datatable').DataTable({
                ...
                searching: true,
                ajax: {
                    url: '{{ route('punjab-action-plans.index') }}',
                    type: "GET",
                    data: function (row) {
                        row.test = 1;
                    }
                ...
                columns: [
                    ...
                    {data: 'department_name', name: 'department.department_name'},
                        @endif
                    {data: 'year', name: 'year'},
                    {data: 'target_value', name: 'target.target_value'},
                    {data: 'indicator_title', name: 'indicator.indicator_title'},
                    {data: 'baseline', name: 'baseline'},
                    {data: 'reporting_agency', name: 'reporting_agency'},
