...
@push('title', 'Women Ombudsperson: Violence Against Women')
@push('breadcrumb-items')
    <li class="breadcrumb-item">
        <a class="text-muted">Women Ombudsperson: Violence Against Women</a>
    </li>
@endpush
@section('content')
    <!--begin::Entry-->
            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap border-0 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Women Ombudsperson: Violence Against Women</h3>
                    </div>
                    @if(auth()->user()->isDepartment())
                        <div class="card-toolbar">
                        <!--begin::Button-->
                        <a href="{{ route('women-ombudsperson-violences.create') }}" class="btn btn-primary bg-white btn-outline-white text-danger font-weight-bolder">New Violence</a>
                        <!--end::Button-->
                    </div>
                    @endif
                </div>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            myDataTable = $('#my_datatable').DataTable({
                ...
                searching: true,
                ajax: {
                    url: '{{ route('women-ombudsperson-violences.index') }}',
                    type: "GET",
                    data: function (row) {
                        row.test = 1;
                    }
                ...
                columns: [
                    ...
                    {data: 'total_cases_in_progress', name: 'total_cases_in_progress'},
