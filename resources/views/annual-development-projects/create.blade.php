...
@push('title', 'Add Gender Segregation Budgeting')
        ...
        <div class="container">
                    ...
                    <div class="card card-custom gutter-b example-compact">
                        <div class="card-header">
                            <h3 class="card-title">Add Gender Segregation Budgeting</h3>

                        </div>

                        <!--begin::Form-->
                        {!! Form::open(array('id'=>'form_add_edit','route' => 'annual-development-projects.store','method'=>'POST','files' => 'true')) !!}
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" name="total_approved_budget" style="width: 100% !important;" class="form-control money_format" placeholder="Approved Budget (Rs in Million)" value="{{ old('total_approved_budget') }}" />
                                        ...
                                        @for($index =0; $index<count(old('project_budgets',array())); $index++)
                                            <tr>
                                                <td>
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <input readonly type="text" name="project_budgets[{{ $index }}][fiscal_year]" style="width: 100% !important;" class="form-control fiscal_years" placeholder="Fiscal Year" value="{{ old("project_budgets.{$index}.fiscal_year") }}" />
                                                ...
                                                <td>
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <input type="text" name="project_budgets[{{ $index }}][budget_allocation]" style="width: 100% !important;" class="form-control budget_allocations money_format" placeholder="Budget Allocation (Million)" value="{{ old("project_budgets.{$index}.budget_allocation") }}"  />
                                                ...
                                                <td>
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            <input type="text" name="project_budgets[{{ $index }}][budget_utilization]" style="width: 100% !important;" class="form-control budget_utilizations money_format" placeholder="Budget Utilization (Million)" value="{{ old("project_budgets.{$index}.budget_utilization") }}"  />
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input  type="text" name="total_expenditure" style="width: 100% !important;" class="form-control money_format" placeholder="Total Expenditure till date (as per budget utilized)" value="{{ old('total_expenditure') }}" />
                                    ...
                                    <table class="table table-borderless">
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <input  type="text" name="beneficiary_male" class="form-control beneficiary  money_format" placeholder="Male" value="{{ old('beneficiary_male') }}" />
                                                @error('beneficiary_male') <div class="error">{{ $message }}</div> @enderror
                                            </td>
                                            <td>
                                                <label>Female<span class="color-red-700"></span></label>
                                                <input  type="text" name="beneficiary_female" class="form-control beneficiary money_format" placeholder="Female" value="{{ old('beneficiary_female') }}" />
                                                @error('beneficiary_female') <div class="error">{{ $message }}</div> @enderror
                                            </td>
                                            <td>
                                                <label>Transgender<span class="color-red-700"></span></label>
                                                <input type="text" name="beneficiary_trans_gender" class="form-control beneficiary money_format" placeholder="Transgender" value="{{ old('beneficiary_trans_gender') }}" />
                                                @error('beneficiary_trans_gender') <div class="error">{{ $message }}</div> @enderror
                                            </td>
                                            <td>
                                                <label>Total<span class="color-red-700"></span></label>
                                                <input readonly type="text" id="beneficiary_total" name="beneficiary_total" class="form-control money_format" placeholder="Total" value="{{ old('beneficiary_total') }}" />
                                                @error('beneficiary_total') <div class="error">{{ $message }}</div> @enderror
                                            </td>
                                            <td>
                                                <label>Minority<span class="color-red-700"></span></label>
                                                <input type="text" name="minority" class="form-control money_format" placeholder="Minority" value="{{ old('minority') }}" />
                                                @error('minority') <div class="error">{{ $message }}</div> @enderror
                                            </td>
                                            <td>
                                                <label>Disabilities<span class="color-red-700"></span></label>
                                                <input type="text" name="disability" class="form-control money_format" placeholder="Persons with Disabilities" value="{{ old('disability') }}" />
            ...
            fv = FormValidation.formValidation(
                document.getElementById('form_add_edit'),
                {
                    fields: {
                        ...
                        'progress_reports[0][progress_report_file]': progress_report_rule,
                        total_expenditure : {
                            validators: {
                                notEmpty: {
