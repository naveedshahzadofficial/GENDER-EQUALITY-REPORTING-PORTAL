            ...
            <div class="">
                <div class="">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        ...
                        <!--begin::Form-->
                        {!! Form::open(array('id'=>'form_add_edit','route' => 'federal-agency-violences.store','method'=>'POST','files' => 'true')) !!}
                        <div class="card-body">
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input  type="text" name="total_complaints" class="form-control money_format" placeholder="Total Complaints" value="{{ old('total_complaints') }}" />
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input  type="text" name="complaints_converted_to_fir" class="form-control money_format" placeholder="Converted to FIR" value="{{ old('complaints_converted_to_fir') }}" />
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input  type="text" name="complaints_disposed_without_fir" class="form-control money_format" placeholder="Complaints Disposed" value="{{ old('complaints_disposed_without_fir') }}" />
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input  type="text" name="complaints_in_process" class="form-control money_format" placeholder="Child Marriage" value="{{ old('complaints_in_process') }}" />
                            ...
                            <div class="row form-group">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input  type="text" name="case_completed" class="form-control money_format" placeholder="Case Completed" value="{{ old('case_completed') }}" />
