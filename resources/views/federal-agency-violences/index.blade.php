...
@push('title', 'Federal Investigation Agency: Violence Against Women')
@push('breadcrumb-items')
    <li class="breadcrumb-item">
        <a class="text-muted">Federal Investigation Agency: Violence Against Women</a>
    </li>
@endpush
@section('content')
    <!--begin::Entry-->
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            myDataTable = $('#my_datatable').DataTable({
                ...
                searching: true,
                ajax: {
                    url: '{{ route('federal-agency-violences.index') }}',
                    type: "GET",
                    data: function (row) {
                        row.test = 1;
                    }
                ...
                columns: [
                    ...
                    {data: 'case_completed', name: 'case_completed'},
