<div id="kt_header" class="header header-fixed">
						...
						<div class="container-fluid d-flex align-items-stretch justify-content-between">
							...
							<div class="header-menu-wrapper header-menu-wrapper-left mt-4" id="kt_header_menu_wrapper">
                                <span class="dashboard-logo-sub-heading-main">GENDER EQUALITY</span><br>
                                <span class="dashboard-logo-slogan">REPORTING PORTAL</span>
							</div>
					...
					<div class="d-flex flex-column">
						...
						<div class="navi mt-2">
							...
							<a href="{{ route('logout') }}" onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();"   class="btn btn-sm btn-light-primary custom-btn-form font-weight-bolder py-2 px-5">{{ __('Sign Out') }}</a>
