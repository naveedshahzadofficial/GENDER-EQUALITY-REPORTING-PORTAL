                    ...
                    <div class="card card-custom gutter-b">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mt-10">
                                <div class="col-md-6">
                                    <div class="static-info row">
                                        <div class="col-md-6 name"><strong>Policies/Projects (Year Wise):</strong></div>
                                        <div class="col-md-6 value">{{ $voluntaryNationalReport->year_wise_policies_interventions }}</div>
                                    </div>
                                </div>
