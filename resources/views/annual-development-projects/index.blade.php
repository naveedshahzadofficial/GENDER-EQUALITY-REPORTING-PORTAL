...
@push('breadcrumb-items')
    <li class="breadcrumb-item">
        <a class="text-muted">Gender Segregation Budgeting</a>
    </li>
@endpush
@section('content')
    <!--begin::Entry-->
            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap border-0 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Gender Segregation Budgeting</h3>
                    </div>
                    @if(auth()->user()->isDepartment())
                        <div class="card-toolbar">
                        <!--begin::Button-->
                        <a href="{{ route('annual-development-projects.create') }}" class="btn btn-primary bg-white btn-outline-white text-danger font-weight-bolder">New GSB</a>
                        <!--end::Button-->
                    </div>
                    @endif
                </div>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            myDataTable = $('#my_datatable').DataTable({
                ...
                searching: true,
                ajax: {
                    url: '{{ route('annual-development-projects.index') }}',
                    type: "GET",
                    data: function (row) {
                        row.test = 1;
                    }
                ...
                columns: [
                   ...
                   @endif
                    ...
                    {data: 'total_approved_budget', name: 'total_approved_budget', class: 'text-center'},
                    {data: 'total_expenditure', name: 'total_expenditure', class: 'text-center'},
